            ...
            .addInterceptor(Interceptor { chain ->
                val request: Request =
                    chain.request().newBuilder()
                        .addHeader("Accept-Language", NafhasehaProviderApp.pref.getString(LANG, "ar").toString())
                        .addHeader("Authorization", BEARER +" "+ NafhasehaProviderApp.pref.authToken!!.toString())
                        .build()
