...
import com.sa.nafhasehaprovider.entity.response.carYearsResponse.DataCarYearsResponse


class DropDownCarYearsAdapter(val context: Context, var dataSource: List<DataCarYearsResponse>) :
    BaseAdapter() {
