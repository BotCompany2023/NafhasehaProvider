...
import com.sa.nafhasehaprovider.entity.response.carBrandsResponse.DataCarBrandsResponse


class DropDownCarBrandsAdapter(val context: Context, var dataSource: List<DataCarBrandsResponse>) :
    BaseAdapter() {
