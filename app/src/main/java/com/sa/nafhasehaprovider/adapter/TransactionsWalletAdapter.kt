...
class TransactionsWalletAdapter(
    var context: Activity, var listTransactions: List<TransactionWalletResponse>
) : RecyclerView.Adapter<TransactionsWalletAdapter.ViewHolder?>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        var model = listTransactions[position]
