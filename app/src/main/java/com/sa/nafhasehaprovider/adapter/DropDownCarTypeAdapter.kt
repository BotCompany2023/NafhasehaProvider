...
import com.sa.nafhasehaprovider.entity.response.typeCarResponse.DataCarTypeResponse


class DropDownCarTypeAdapter(val context: Context, var dataSource: List<DataCarTypeResponse>) :
    BaseAdapter() {
