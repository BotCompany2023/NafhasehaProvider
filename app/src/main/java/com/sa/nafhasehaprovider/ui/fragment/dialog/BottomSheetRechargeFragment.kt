...
class BottomSheetRechargeFragment : BaseBottomDialog<FragmentBottomSheetRechargeBinding>() {

    override fun getLayoutId(): Int = R.layout.fragment_bottom_sheet_recharge
